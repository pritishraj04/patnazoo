...
export default function MessagePage() {
  ...
  const { data: directorMessageData, loading } =
    useApiData<DirectorMessageInfo>(`/director-message/${message}`);

  const missionRawData = directorMessageData?.mission;

  const [mission, setMission] = useState<HTMLElement[]>([]);
  ...
  useEffect(() => {
    setMission(parseHtmlToElements(missionRawData));
  }, [missionRawData]);
            ...
            <section className="py-16 bg-zoo-teal-700">
              <div className="zoo-container">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {Object.values(
                    JSON.parse(
                      directorMessageData?.strategic_goals || "{}"
                    ) as {
                      title: string;
                      description: string;
                    }[]
              ...
              <div className="zoo-container">
                <div className="text-center max-w-3xl mx-auto animate-on-scroll">
                  ...
                  <p className="text-xl text-white/80 mb-8">
                    Your support helps us protect wildlife and create a
