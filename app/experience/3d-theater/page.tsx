            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  extraordinary wildlife adventures without leaving your seat.
                  Our state-of-the-art facility brings you face-to-face with
                  nature's most magnificent creatures through immersive 3D
                  documentaries and educational films.
                </p>
                <p className="text-white/90 text-lg mb-4">
                  From the depths of the ocean to the heights of the Himalayas,
                  experience wildlife like never before. Our carefully curated
                  collection of films focuses on conservation, education, and
                  the incredible diversity of life on Earth, making learning
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/20">
                    <p className="text-white/80 text-sm">
                      <strong>Note:</strong> Tickets included with zoo entry.
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-white/80">
                      Central complex, near the main entrance and visitor center
                    </p>
                  </div>
                  <div>
