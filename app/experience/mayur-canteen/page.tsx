  ...
  const facilities = [
    {
      ...
      description:
        "All food prepared in clean, sanitized kitchen following food safety standards",
    },
    {
      icon: <Leaf className="w-6 h-6" />,
      title: "100% Vegetarian",
      description:
        "Complete vegetarian menu respecting diverse dietary preferences",
    },
    {
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-white/90 text-lg mb-4">
                  Mayur Canteen offers a delightful dining experience right in
                  the heart of Patna Zoo. Our vegetarian restaurant serves
                  authentic Indian cuisine, snacks, and refreshing beverages to
                  fuel your zoo adventure.
                </p>
                <p className="text-white/90 text-lg mb-4">
                  From traditional Bihar specialties to popular Indian street
                  food, our menu caters to all tastes and ages. Enjoy your meal
                  in our comfortable seating area with views of the zoo's
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-zoo-teal-900/80 to-transparent p-6">
                  <p className="text-white/90 text-sm">
                    Comfortable dining area with zoo views
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="zoo-container">
            ...
            >
              ...
              <p className="text-xl text-white/80">
                Delicious vegetarian options for every taste
              </p>
            </div>
        ...
        <section className="py-16 bg-zoo-teal-700">
          <div className="zoo-container">
            ...
            >
              <h2 className="font-heading text-4xl md:text-5xl text-white mb-4">
                WHY CHOOSE MAYUR CANTEEN
              </h2>
              <p className="text-xl text-white/80">
                Quality food and service for a perfect dining experience
              </p>
            </div>
        ...
        <section className="py-16 bg-zoo-teal-800">
          <div className="zoo-container">
            ...
            >
              ...
              <p className="text-xl text-white/80">
                Take a look at our dining space and delicious food
              </p>
            </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-white/80">
                      Central area of Patna Zoo, near the main pathway
                    </p>
                  </div>
                  <div>
                    <p className="font-medium mb-1">Seating Capacity</p>
                    <p className="text-white/80">
                      80 people (Indoor & Outdoor seating)
                    </p>
                  </div>
                  <div>
                    <p className="font-medium mb-1">Special Services</p>
                    <p className="text-white/80">
                      Group bookings available for school trips and events
                    </p>
                  </div>
                </CardContent>
              </Card>
