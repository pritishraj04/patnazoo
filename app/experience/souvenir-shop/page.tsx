            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-white/90 text-lg mb-4">
                  ...
                  toys, educational materials, and memorabilia that celebrate
                  wildlife and support conservation efforts. Every purchase
                  helps fund our zoo's mission to protect and preserve
                  endangered species.
                </p>
                <p className="text-white/90 text-lg mb-4">
                  From cuddly plush animals to educational books, eco-friendly
                  products to unique handicrafts, find the perfect memento of
                  your zoo visit. Our items are carefully selected to inspire
                  love for wildlife and environmental awareness.
                </p>
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/20">
                    <p className="text-white/80 text-sm">
                      <strong>Note:</strong> Extended hours during festivals and
                      special events
                    </p>
                  </div>
                </CardContent>
