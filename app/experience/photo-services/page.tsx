                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                  ...
                  >
                    ...
                    <p className="text-white/90 text-lg mb-4">
                      ...
                      photography, ensuring you take home stunning memories of
                      your visit.
                    </p>
                    <p className="text-white/90 text-lg mb-4">
                      From family portraits with exotic animals to wildlife
                      photography workshops, we offer comprehensive services to
                      suit every need. Our state-of-the-art equipment and expert
                      editing ensure high-quality results every time.
                    </p>
