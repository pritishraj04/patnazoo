            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-white/90 text-lg mb-4">
                  Escape into tranquility at our beautiful boating lake, nestled
                  within the heart of Patna Zoo. This pristine water body offers
                  visitors a chance to relax and enjoy nature from a unique
                  perspective while observing wildlife around the lake's edges.
                </p>
                <p className="text-white/90 text-lg mb-4">
                  Choose from our variety of boats including pedal boats, row
                  boats, and electric boats. Whether you're seeking adventure,
                  romance, or family fun, our lake provides the perfect setting
                  for memorable moments surrounded by nature's beauty.
                </p>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-zoo-teal-900/80 to-transparent p-6">
                  <p className="text-white/90 text-sm">
                    Peaceful boating experience on our scenic lake
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="zoo-container">
            ...
            >
              ...
              <p className="text-xl text-white/80">
                Choose your perfect boat for an unforgettable lake experience
              </p>
            </div>
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/20">
                    <p className="text-white/80 text-sm">
                      <strong>Note:</strong> Weather dependent - closed during
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">
                      Life jackets provided, trained lifeguards on duty, shallow
                      water areas
                    </p>
                  </div>
                  <div>
