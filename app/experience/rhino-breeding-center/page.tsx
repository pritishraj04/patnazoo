  ...
  const programCategories = [
    {
      ...
      activities: [
        ...
        },
        {
          ...
          description:
            "Advanced reproductive techniques to increase breeding success",
          status: "Active",
          success: "3 successful births",
          details:
            "State-of-the-art veterinary facilities support reproductive health",
        },
        {
          name: "Pregnancy Monitoring",
          description:
            "24/7 monitoring of pregnant females with veterinary care",
          status: "Continuous",
          success: "100% survival rate",
          details:
            "Regular ultrasounds and health checkups ensure safe pregnancies",
        },
      ],
    },
    {
      ...
      activities: [
        {
          ...
          description:
            "Creating natural habitat conditions for optimal breeding environment",
          status: "Phase 2",
          area: "15 acres",
          details:
            "Native vegetation and water sources replicate wild conditions",
        },
        {
          ...
          details:
            "Sharing knowledge and best practices with global rhino conservation network",
        },
        {
          name: "Anti-Poaching Awareness",
          description:
            "Educational programs about rhino conservation and anti-poaching efforts",
          status: "Ongoing",
      ...
      activities: [
        {
          ...
          description:
            "Studying rhino behavior patterns to improve breeding success",
          status: "Year 3",
        ...
        },
        {
          ...
          description:
            "Comprehensive health tracking using latest veterinary technology",
          status: "Daily",
      ...
      activities: [
        {
          name: "School Visits",
          description:
            "Educational tours for students about rhino conservation",
          frequency: "Weekly",
        ...
        },
        {
          ...
          description:
            "Training programs for wildlife conservation professionals",
          frequency: "Quarterly",
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-white/90 text-lg mb-4">
                  Our Rhino Breeding Center stands as a beacon of hope for one
                  of the world's most endangered species. Established in 2018,
                  this state-of-the-art facility has successfully bred 12
                  healthy rhino calves, contributing significantly to the global
                  conservation efforts for the Greater One-Horned Rhinoceros.
                </p>
                <p className="text-white/90 text-lg mb-4">
                  Through advanced reproductive techniques, comprehensive
                  veterinary care, and international collaboration, we're not
                  just breeding rhinos – we're securing their future. Our
                  program combines cutting-edge science with traditional
                          ...
                          (activity: any, index: number) => (
                            ...
                            >
                              ...
                              <div className="flex flex-wrap gap-4 mt-3 text-xs text-zoo-yellow-600">
                                ...
                                {activity.technology && (
                                  <span>Technology: {activity.technology}</span>
                                )}
                                {activity.frequency && (
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-white/20">
                    <p className="text-white/80 text-sm">
                      <strong>Note:</strong> Advance booking required for guided
