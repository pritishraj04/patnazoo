...
export default function ContactPage() {
  ...
  const { data: qnasData } = useApiData<FaqsItems[]>("/faq/qna");
          ...
          <div className="zoo-container">
            ...
            >
              ...
              <p className="text-xl text-white/80">
                We're here to help with any questions about your visit
              </p>
            </div>
                    ...
                    >
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          <div className="text-zoo-yellow-600 flex-shrink-0">
                            {dept.icon}
                          </div>
                          <div>
        ...
        <section className="py-16 bg-zoo-teal-800">
          <div className="zoo-container">
            ...
            >
              ...
              <p className="text-xl text-white/80">
                Located in the heart of Patna, easily accessible by public
                transport
              </p>
            </div>
              ...
              <CardContent className="p-0">
                <div className="h-96 bg-gray-200 flex items-center justify-center">
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-sm">
                      Sanjay Gandhi Biological Park, Bailey Road, Patna
                    </p>
                  </div>
                </div>
                <div className="p-6">
                  <div className="grid md:grid-cols-3 gap-6">
                    <div>
                      <h4 className="font-heading text-lg text-zoo-teal-700 mb-2">
                        By Car
                      </h4>
                      <p className="text-zoo-teal-600 text-sm">
                        Free parking available at Gate No. 1 & 2. Follow Bailey
                        Road from Patna city center.
                      </p>
                    </div>
                    <div>
                      <h4 className="font-heading text-lg text-zoo-teal-700 mb-2">
        ...
        <section className="py-16 bg-zoo-teal-700">
          <div className="zoo-container">
            ...
            >
              ...
              <p className="text-xl text-white/80">
                Common questions and immediate answers
              </p>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {qnasData?.map((faq, index) => (
                <Card
                  key={index}
                  className={`bg-white/10 border-white/20 text-white transition-all duration-500 hover:scale-105 ${
                    isVisible
