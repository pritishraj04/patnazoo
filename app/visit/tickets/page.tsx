...
export default function TicketsPage() {
  ...
  const [activeTab, setActiveTab] = useActiveTab(menuDataTransformed);
  ...
  const ticketTypes = useMemo(() => {
    ...
    return menuData?.map((tabData) => ({
      id: tabData.id.toLowerCase().replace(/\s+/g, "-"),
      name: tabData.name,
      description: tabData.description,
      prices: tabData.prices.map((item) => ({
  ...
  const paymentMethods = [
    ...
    { name: "Card", icon: "💳", description: "Debit/Credit cards accepted" },
    {
      name: "Online",
      icon: "🌐",
      description: "Book tickets online (Coming Soon)",
    },
  ];
              ...
              <div className="zoo-container">
                ...
                >
                  ...
                  <p className="text-xl text-white/80">
                    Plan your visit around our operating schedule
                  </p>
                </div>
            ...
            <section className="py-16 bg-zoo-teal-700">
              <div className="zoo-container">
                ...
                >
                  ...
                  <p className="text-xl text-white/80">
                    Parking fees for different vehicles
                  </p>
                </div>
            ...
            <section className="py-16 bg-zoo-teal-700">
              <div className="zoo-container">
                ...
                >
                  ...
                  <p className="text-xl text-white/80">
                    Charges for cloak room services
                  </p>
                </div>
            ...
            <section className="py-16 bg-zoo-teal-800">
              <div className="zoo-container">
                ...
                >
                  ...
                  <p className="text-xl text-white/80">
                    Fees for extended entry passes
                  </p>
                </div>
                ...
                <Card className="bg-gradient-to-r from-orange-500 to-yellow-500 border-none text-white max-w-4xl mx-auto">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-lg mb-6">
                      We're working on an online ticket booking system to make
                      your visit planning even easier. For now, tickets are
                      available at the zoo entrance.
                    </p>
              ...
              <div className="zoo-container">
                <div className="text-center max-w-3xl mx-auto animate-on-scroll">
                  ...
                  <p className="text-xl text-white/80 mb-8">
                    Plan your perfect day at Patna Zoo with our visitor
                    resources
                  </p>
